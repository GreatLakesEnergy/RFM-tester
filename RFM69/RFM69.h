...
class RFM69 {
  public:
    ...
    bool initialize_19k2(uint8_t freqBand, uint8_t ID, uint8_t networkID=1);
    bool initialize_1k9(uint8_t freqBand, uint8_t ID, uint8_t networkID=1);
    ...
    //void setBitrate(uint8_t MSB, uint8_t LSB);
