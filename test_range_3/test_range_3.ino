  ...
  if(NODEID==MASTER){
    ...
    // *** Eo if-Master
      ...
      if(radio.receiveDone() ){
        ...
        if(message.data[0] =='#' && message.data[1] =='i'
              && message.data[2] ==',' ) {
          // # i , 
        ...
        // Command for BITRATE
        if(message.data[0] =='#' && message.data[1] =='b'
            && message.data[2] ==',' ) 
        {
...
// Arduino to-the-power-of function was failing me, this is needed for string to integer conversion
